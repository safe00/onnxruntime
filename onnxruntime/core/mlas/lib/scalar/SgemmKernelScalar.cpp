...
--*/
{
    ...
    do {
        ...
        Row0Block0 = MlasMultiplyFloat32x4(Row0Block0, MlasBroadcastFloat32x4(alpha));
        Row0Block1 = MlasMultiplyFloat32x4(Row0Block1, MlasBroadcastFloat32x4(alpha));
        Row0Block2 = MlasMultiplyFloat32x4(Row0Block2, MlasBroadcastFloat32x4(alpha));
        Row0Block3 = MlasMultiplyFloat32x4(Row0Block3, MlasBroadcastFloat32x4(alpha));

        if (ProcessTwoRows) {
            Row1Block0 = MlasMultiplyFloat32x4(Row1Block0, MlasBroadcastFloat32x4(alpha));
            Row1Block1 = MlasMultiplyFloat32x4(Row1Block1, MlasBroadcastFloat32x4(alpha));
            Row1Block2 = MlasMultiplyFloat32x4(Row1Block2, MlasBroadcastFloat32x4(alpha));
            Row1Block3 = MlasMultiplyFloat32x4(Row1Block3, MlasBroadcastFloat32x4(alpha));
        }
        ...
        if (CountN >= 16) {
            ...
            float Row0Block0High0;
            float Row0Block0High1;
            float Row0Block0Low0;
            float Row0Block0Low1;

            float Row1Block0High0;
            float Row1Block0High1;
            float Row1Block0Low0;
            float Row1Block0Low1;

            Row0Block0High1 = MlasExtractLaneFloat32x4<3>(Row0Block0);
            Row0Block0High0 = MlasExtractLaneFloat32x4<2>(Row0Block0);
            Row0Block0Low1 = MlasExtractLaneFloat32x4<1>(Row0Block0);
            Row0Block0Low0 = MlasExtractLaneFloat32x4<0>(Row0Block0);

            if (ProcessTwoRows) {
                Row1Block0High1 = MlasExtractLaneFloat32x4<3>(Row1Block0);
                Row1Block0High0 = MlasExtractLaneFloat32x4<2>(Row1Block0);
                Row1Block0Low1 = MlasExtractLaneFloat32x4<1>(Row1Block0);
                Row1Block0Low0 = MlasExtractLaneFloat32x4<0>(Row1Block0);
            }

            if ((CountN & 2) != 0) {

                if (!ZeroMode) {
                    Row0Block0Low0 = Row0Block0Low0 + C[0];
                    Row0Block0Low1 = Row0Block0Low1 + C[1];
                }

                C[0] = Row0Block0Low0;
                C[1] = Row0Block0Low1;
                Row0Block0Low1 = Row0Block0High1;
                Row0Block0Low0 = Row0Block0High0;

                if (ProcessTwoRows) {

                    if (!ZeroMode) {
                        Row1Block0Low0 = Row1Block0Low0 + C[ldc + 0];
                        Row1Block0Low1 = Row1Block0Low1 + C[ldc + 1];
                    }

                    C[ldc + 0] = Row1Block0Low0;
                    C[ldc + 1] = Row1Block0Low1;
                    Row1Block0Low1 = Row1Block0High1;
                    Row1Block0Low0 = Row1Block0High0;
                }
